  ...
  <div class="min-h-screen bg-slate-900 flex items-center justify-center px-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        <div class="w-16 h-16 rounded-2xl bg-sky-600 flex items-center justify-center mx-auto mb-4">
          <FileText class="w-10 h-10 text-white" />
        </div>
        <h1 class="text-2xl font-bold text-white">Sistem Pengaduan</h1>
        <p class="text-slate-400 mt-2">Universitas Islam Riau</p>
      </div>
      ...
      <div class="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden">
        ...
        <form v-if="tab === 'login'" @submit.prevent="handleLogin" class="p-6 space-y-4">
          ...
          <button
            type="submit"
            :disabled="loading"
            class="w-full py-2.5 px-4 bg-sky-600 text-white font-medium rounded-lg hover:bg-sky-700 focus:ring-4 focus:ring-sky-500/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <form v-else @submit.prevent="handleRegister" class="p-6 space-y-4">
          <div>
            <label for="reg-name" class="block text-sm font-medium text-slate-300 mb-1">
              Nama Lengkap
            </label>
            <input
              id="reg-name"
          ...
          <div>
            <label for="reg-npm" class="block text-sm font-medium text-slate-300 mb-1">
          ...
          <div>
            <label for="reg-email" class="block text-sm font-medium text-slate-300 mb-1">
              Email
            </label>
            <input
              id="reg-email"
          ...
          <div>
            <label for="reg-password" class="block text-sm font-medium text-slate-300 mb-1">
              Password
            </label>
            <input
              id="reg-password"
          ...
          <div>
            <label for="reg-confirm" class="block text-sm font-medium text-slate-300 mb-1">
              Konfirmasi Password
            </label>
            <input
              id="reg-confirm"
      ...
      <p class="text-center text-slate-500 text-sm mt-6">
        &copy; 2024 Sistem Pengaduan Mahasiswa UIR
      </p>
    </div>
  </div>
</template>
